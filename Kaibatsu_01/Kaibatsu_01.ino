...
*/
    if (newData){
      ...
      caculateP0(BLE_reading_altitude, BLE_reading_pressure);
    }
...
void caculateP0(int BLE_reading_altitude, double BLE_reading_pressure){

    P0 = bmp.sealevel(BLE_reading_pressure, BLE_reading_altitude);
